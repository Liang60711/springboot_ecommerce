package com.ricoliang.springboot_ecommerce;
...
public class SpringbootEcommerceApplicationTests {
    ...
    public void getProduct_notFound() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/products/{productId}", 100000);
    ...
    public void createProduct_success() throws Exception {
        ...
        productRequest.setProductName("X4 Coupe");
        productRequest.setCategory(ProductCategory.CAR);
        productRequest.setImageUrl("http://car.com");
        productRequest.setPrice(1000000);
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.productName", equalTo("X4 Coupe")))
                .andExpect(jsonPath("$.category", equalTo("CAR")))
                .andExpect(jsonPath("$.imageUrl", equalTo("http://car.com")))
                .andExpect(jsonPath("$.price", equalTo(1000000)))
